  ...
  class m {
    ...
    trial(e, t) {
      ...
      if (t.render_on_canvas) {
        ...
        const n = () => {
          t.stimulus_height !== null
            ...
            t.stimulus_width !== null
              ...
              : (t.stimulus_height !== null && t.maintain_aspect_ratio) ||
                (i = a.naturalWidth),
            (l.height = s),
            (l.width = i);
        };
        ...
        t.prompt !== null && (d += t.prompt), (e.innerHTML = d);
      ...
      const p = () => {
        typeof c != "undefined" &&
          this.jsPsych.pluginAPI.cancelKeyboardResponse(c);
