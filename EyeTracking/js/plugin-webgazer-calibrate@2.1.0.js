var jsPsychWebgazerCalibrate = (function (t) {
  ...
  class d {
    ...
    trial(r, e) {
      ...
      r.innerHTML = y;
      var l = r.querySelector("#webgazer-calibrate-container"),
        u = 0,
        o = -1,
        n = null;
      const b = () => {
        ...
        f = () => {
          i.resume(),
            e.calibration_mode == "click" && i.startMouseCalibration(),
            b();
        },
        c = () => {
          if ((o++, o == n.length))
            u++, u == e.repetitions_per_point ? w() : b();
          else {
            var a = n[o];
            v(a);
          }
        ...
        v = (a) => {
          var g = `<div id="calibration-point" style="width:${e.point_size}px; height:${e.point_size}px; border-radius:${e.point_size}px; border: 1px solid #000; background-color: #333; position: absolute; left:${a[0]}%; top:${a[1]}%;"></div>`;
          l.innerHTML = g;
          var p = l.querySelector("#calibration-point");
          if (
            ...
            var s = p.getBoundingClientRect(),
              ...
              j = performance.now() + e.time_to_saccade + e.time_per_point;
            const m = () => {
              performance.now() > L && i.calibratePoint(T, z),
                performance.now() < j ? requestAnimationFrame(m) : c();
            };
            requestAnimationFrame(m);
          }
        },
        w = () => {
          e.calibration_mode == "click" && i.stopMouseCalibration(),
            (l.innerHTML = ""),
            P();
        },
        P = () => {
...
//# sourceMappingURL=https://unpkg.com/@jspsych/plugin-webgazer-calibrate@2.1.0/dist/index.browser.min.js.map
