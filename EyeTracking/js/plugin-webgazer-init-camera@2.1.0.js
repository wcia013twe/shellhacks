    ...
    trial(o, s, y) {
      ...
      const b = () => {
        ...
        `;
          ...
          (o.innerHTML = l), t.showVideo(), t.resume();
          var w = o.querySelector("#webgazer-init-container");
          if (
            ((w.innerHTML = `
      ...
      t.isInitialized()
        ...
        : t
            ...
            .catch((e) => {
              console.log(e),
                (o.innerHTML = `<p>The experiment cannot continue because the eye tracker failed to start.</p>
...
//# sourceMappingURL=https://unpkg.com/@jspsych/plugin-webgazer-init-camera@2.1.0/dist/index.browser.min.js.map
