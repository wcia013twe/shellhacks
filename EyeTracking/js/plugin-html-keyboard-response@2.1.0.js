var jsPsychHtmlKeyboardResponse = (function (i) {
  "use strict";
  var u = "2.1.0";
  const p = {
    ...
    version: u,
    parameters: {
      stimulus: { type: i.ParameterType.HTML_STRING, default: void 0 },
    ...
    data: {
      ...
      stimulus: { type: i.ParameterType.STRING },
    },
    citations: {
  ...
  class n {
    ...
    trial(t, e) {
      var a =
        ...
        e.stimulus +
        "</div>";
      e.prompt !== null && (a += e.prompt), (t.innerHTML = a);
      var s = { rt: null, key: null };
      const r = () => {
        typeof o != "undefined" &&
          this.jsPsych.pluginAPI.cancelKeyboardResponse(o);
        var l = { rt: s.rt, stimulus: e.stimulus, response: s.key };
      ...
      var m = (l) => {
        (t.querySelector(
          ...
          s.key == null && (s = l),
          e.response_ends_trial && r();
      };
      if (e.choices != "NO_KEYS")
      ...
      e.stimulus_duration !== null &&
        ...
        e.trial_duration !== null &&
          this.jsPsych.pluginAPI.setTimeout(r, e.trial_duration);
    }
    simulate(t, e, a, s) {
      e == "data-only" && (s(), this.simulate_data_only(t, a)),
        e == "visual" && this.simulate_visual(t, a, s);
    }
    ...
    simulate_visual(t, e, a) {
      ...
      this.trial(r, t),
        a(),
        s.rt !== null && this.jsPsych.pluginAPI.pressKey(s.response, s.rt);
    }
  }
  return (n.info = p), n;
})(jsPsychModule);
